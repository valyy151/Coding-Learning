...
buttonG.addEventListener('click', () => window.scroll({ top: 1210 }))

const buttonF = document.getElementById('buttonF')
buttonF.addEventListener('click', () => window.scroll({ top: 2460 }))

const buttonH = document.getElementById('buttonH')
buttonH.addEventListener('click', () => window.scroll({ top: 3700 }))
